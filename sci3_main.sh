...
# Must source the conda.sh file then activate sciRNA3 env prior to submitting script
source /data/$USER/conda/etc/profile.d/conda.sh 
conda activate sciRNA3


# define the fastq folder including all fastq files
fastq_folder="/data/VisionDevo/FQ/GSE186824/"

# define the PCR group sample id for each fastq file
sample_ID="/data/VisionDevo/MB/230801/src/sample_ID.txt"

# define the output folder
all_output_folder="/data/VisionDevo/MB/230801/output"
...
index="/fdb/STAR_indices/2.7.10b/GENCODE/Gencode_mouse/release_M27/genes-100"

# define the gtf file for gene counting
gtf_file="/fdb/STAR_indices/2.7.10b/GENCODE/Gencode_mouse/release_M27/genes.gtf"

#define the mismatch rate for removing duplicates:
mismatch=1

# Define the location of the sub script folder
script_folder="/data/VisionDevo/tools/sci-RNA-seq3_pipeline/script_folder/"

#define the bin of python (python V2.7)
python_path="/data/brooksma/conda/envs/sciRNA3/bin/"
